...
const Hero = () => {
  return (
    ...
    >
      <div className="p-2 mb-12 mt-6 sm:max-w-[50%]">
        <h1 className="text-5xl font-bold dark:text-white text-black text-center my-3">
          HELLO WORLD
        </h1>
        <h2 className="text-2xl font-semibold text-center dark:text-zinc-200">
          MY NAME IS{" "}
