...
const Navbar = ({
  ...
  return (
    <nav
      className={`sticky top-0 z-40 flex flex-row h-[82px] sm:h-auto px-5 sm:px-8 md:px-10 items-center justify-between ${
        !theme ? "glassmorph" : "glassmorph-dark"
      } py-4`}
    >
      <SwapIcon setSidenav={setSidenav} sidenav={sidenav} />
